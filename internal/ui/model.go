...
func defaultPaletteItems() []PaletteItem {
	return []PaletteItem{
		...
		{ID: "allocation", Label: "Disk allocation", Keys: "V", Group: "Cluster"},
		{ID: "settings", Label: "Cluster settings", Keys: "U", Group: "Cluster"},
		{ID: "tasks", Label: "Tasks", Keys: "W", Group: "Cluster"},
		{ID: "plugins", Label: "Plugins", Keys: "P", Group: "Cluster"},
		{ID: "aliases", Label: "Aliases", Keys: "A", Group: "Indices"},
		{ID: "templates", Label: "Index templates", Keys: "T", Group: "Indices"},
		{ID: "datastreams", Label: "Data streams", Keys: "E", Group: "Indices"},
		{ID: "snapshots", Label: "Snapshots", Keys: "Z", Group: "Indices"},
		...
		{ID: "reindex", Label: "Reindex", Keys: "I", Group: "Tools"},
		{ID: "export", Label: "Export documents", Keys: "Q", Group: "Tools"},
		{ID: "saved", Label: "Saved queries", Keys: "Y", Group: "Tools"},
